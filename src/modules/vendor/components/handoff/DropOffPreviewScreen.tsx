...
import { useHandoffLookup } from "@/modules/vendor/hooks/use-handoff-lookup";
    ...
    return (
      <div className="min-h-screen bg-bg-canvas flex flex-col items-center justify-center px-6 text-center">
        ...
        <div className="flex flex-col gap-3 w-full max-w-[280px]">
          <Button size="lg" fullWidth onClick={() => router.push(ROUTES.vendorScan)}>
            Scan Another Parcel
          </Button>
          <Button
            size="lg"
      ...
      <div className="min-h-screen bg-bg-canvas">
        ...
        <div className="px-4 md:px-6 pt-2 md:pt-6 pb-8 max-w-[480px] mx-auto">
          <EmptyState
            ...
            action={
              <Button size="md" onClick={() => router.push(ROUTES.vendorScan)}>
                Try Another Code
              </Button>
            }
          />
      ...
      <div className="min-h-screen bg-bg-canvas">
        ...
        <div className="px-4 md:px-6 pt-2 md:pt-6 pb-8 max-w-[480px] mx-auto">
          ...
          <Button
            ...
            variant="outline"
            className="mt-4"
            onClick={() => router.push(ROUTES.vendorScan)}
          >
            Back to Scanner
          </Button>
        </div>
