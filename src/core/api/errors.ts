  ...
  switch (error.code) {
    ...
    case "INVALID_VERIFICATION_TOKEN":
      return {
        ...
        message:
          "Your email verification link is invalid, expired, or has already been used.",
        action:
          "No need to worry — verifying your email isn't required to use Locoomo.",
        type: "warning",
      };
    ...
    case "INTERNAL_ERROR":
      return {
        title:
          "Locoomo is getting things ready",
        message:
